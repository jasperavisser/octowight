...
create or replace function log_atom_change_event(atom_id bigint, atom_locus varchar(256), atom_type varchar(256))
	returns void as $$ begin
		insert into octowight.atom_change_event(id, atom_id, atom_locus, atom_type)
			values(nextval('octowight.event_sequence'), atom_id, atom_locus, atom_type);
